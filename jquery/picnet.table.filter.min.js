...
'Кавычки (") совпадение фразы. (not) исключить совпадение из результата. (or) логическое "или" т.е. [red or blue] будет выбрано red или blue.';$$$$1$$.fn.tableFilter.defaults={additionalFilterTriggers:[],clearFiltersControls:[],matchingRow:null,matchingCell:null,filteringRows:null,filteredRows:null,filterDelay:200,selectOptionLabel:"Select..."}})($);
